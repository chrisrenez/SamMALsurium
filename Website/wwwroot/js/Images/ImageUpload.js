 ...
 */
function setupSelectButton(elements) {
 ...
 */
function setupFileInput(elements) {
 ...
 */
function setupRemoveButton(elements) {
...
function showImagePreview(file, elements) {
    const { dropZone, dropZoneContent, imagePreview, previewImage, previewFilename, previewFilesize } = elements;
